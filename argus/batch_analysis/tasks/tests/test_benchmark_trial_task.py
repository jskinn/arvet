...
import argus.batch_analysis.tasks.benchmark_trial_task as task


class TestBenchmarkTrialTask(argus.database.tests.test_entity.EntityContract, unittest.TestCase):
