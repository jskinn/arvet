...
class ImageCollectionBuilder:
    ...
    def __init__(self, db_client):
        ...
        self._sequence_type = argus.core.sequence_type.ImageSequenceType.SEQUENTIAL
    ...
    def add_image(self, image, timestamp=None):
        ...
        if hasattr(image, 'identifier') and image.identifier is not None:
            ...
            image_id = argus.core.image_entity.save_image(self._db_client, image)
    ...
    def add_from_image_source(self, image_source, filter_function=None, offset=0):
        ...
        if (len(self._image_ids) > 0 or
                image_source.sequence_type == argus.core.sequence_type.ImageSequenceType.NON_SEQUENTIAL):
            self._sequence_type = argus.core.sequence_type.ImageSequenceType.NON_SEQUENTIAL
        with image_source:
    ...
    def save(self):
        ...
        if len(self._image_ids) > 0:
            return argus.core.image_collection.ImageCollection.create_and_save(
