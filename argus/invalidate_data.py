...
import argus.batch_analysis.invalidate
...
def main():
    ...
    for system_id in orbslam_ids:
        ...
        argus.batch_analysis.invalidate.invalidate_system(db_client, system_id['_id'])
    ...
    for trial_id in failed_trials:
        ...
        argus.batch_analysis.invalidate.invalidate_trial_result(db_client, trial_id['_id'])
