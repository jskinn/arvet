...
def invalidate_image_collection(db_client: database.client.DatabaseClient, image_source_id: bson.ObjectId):
    """
    ...
    core.image_collection.delete_image_collection(db_client, image_source_id)
    logging.getLogger(__name__).info("removed 1 image sources")


def invalidate_controller(db_client: database.client.DatabaseClient, controller_id: bson.ObjectId):
    """
