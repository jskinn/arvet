...
class TestTrackingBenchmark(unittest.TestCase):
    ...
    def test_benchmark_produces_expected_results(self):
        ...
        self.assertEqual(3, result.times_lost)
        self.assertEqual(2.3333, result.lost_intervals[0].start_time)
        self.assertEqual(3, result.lost_intervals[0].end_time)
        self.assertEqual(3 - 2.3333, result.lost_intervals[0].duration)
        self.assertEqual(20, result.lost_intervals[0].distance)
        self.assertEqual(2, result.lost_intervals[0].frames)

        self.assertEqual(3.3333, result.lost_intervals[1].start_time)
        self.assertEqual(4.3333, result.lost_intervals[1].end_time)
        self.assertAlmostEqual(1, result.lost_intervals[1].duration)
        self.assertEqual(30, result.lost_intervals[1].distance)
        self.assertEqual(3, result.lost_intervals[1].frames)

        self.assertEqual(4.6667, result.lost_intervals[2].start_time)
        self.assertEqual(4.6667, result.lost_intervals[2].end_time)
        self.assertEqual(0, result.lost_intervals[2].duration)
        self.assertEqual(0, result.lost_intervals[2].distance)
        self.assertEqual(1, result.lost_intervals[2].frames)
