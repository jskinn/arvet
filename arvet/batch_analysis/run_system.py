...
def test_vision_system(system, database_client, config=None):
    ...
    for dataset_id in dataset_ids:
        ...
        if isinstance(system, arvet.core.trained_system.TrainedVisionSystem):
...
def test_trained_vision_system(system, database_client, config=None):
    if (not isinstance(system, arvet.core.trained_system.TrainedVisionSystem) or
            not isinstance(database_client, arvet.database.client.DatabaseClient)):
        return
