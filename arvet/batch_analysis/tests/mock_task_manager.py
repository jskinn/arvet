...
import arvet.batch_analysis.tasks.import_dataset_task as idt
import arvet.batch_analysis.tasks.generate_dataset_task as gdt
import arvet.batch_analysis.tasks.train_system_task as tst
import arvet.batch_analysis.tasks.run_system_task as rst
import arvet.batch_analysis.tasks.benchmark_trial_task as btt
import arvet.batch_analysis.tasks.compare_trials_task as ctt
import arvet.batch_analysis.tasks.compare_benchmarks_task as cbt
...
class ZombieTaskManager:
    ...
    @property
    def mock(self) -> arvet.batch_analysis.task_manager.TaskManager:
        """
...
def create() -> ZombieTaskManager:
    ...
    """
    return ZombieTaskManager(mock.create_autospec(arvet.batch_analysis.task_manager.TaskManager))
