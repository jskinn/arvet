...
import arvet.batch_analysis.tasks.benchmark_trial_task as task


class TestBenchmarkTrialTask(arvet.database.tests.test_entity.EntityContract, unittest.TestCase):
