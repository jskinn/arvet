...
def load_object(db_client: arvet.database.client.DatabaseClient, collection: pymongo.collection.Collection,
                id_: bson.ObjectId, **kwargs) -> typing.Union[None, arvet.database.entity.Entity]:
    """
...
def add_unique(collection: pymongo.collection.Collection, entity: arvet.database.entity.Entity) -> bson.ObjectId:
    """
