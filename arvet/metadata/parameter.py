...
class ContinuousParameter(arvet.database.entity.Entity):
...
class IntegerParameter(arvet.database.entity.Entity):
...
class DiscreteEnumParameter(arvet.database.entity.Entity):
    """
...
class IndependentEnum(arvet.database.entity.Entity):
    pass
