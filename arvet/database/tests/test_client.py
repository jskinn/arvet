...
class TestDatabaseClient(unittest.TestCase):
    ...
    @mock.patch('arvet.database.client.os.makedirs', autospec=os.makedirs)
    @mock.patch('arvet.database.client.gridfs.GridFS', autospec=gridfs.GridFS)
    @mock.patch('arvet.database.client.pymongo.MongoClient', autospec=pymongo.MongoClient)
    ...
    def test_creates_temporary_folder(self, mock_makedirs, *_):
        folder_name = 'arealfolder/anotherrealfolder_' + str(random.uniform(-10000, 10000))
        arvet.database.client.DatabaseClient({
            'database_config': {
                'temp_folder': folder_name
            }
        })
    ...
    @mock.patch('arvet.database.client.gridfs.GridFS', autospec=gridfs.GridFS)
    @mock.patch('arvet.database.client.pymongo.MongoClient', autospec=pymongo.MongoClient)
    @mock.patch('arvet.database.client.importlib', autospec=importlib)
