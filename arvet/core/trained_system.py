...
class VisionSystemTrainer(arvet.database.entity.Entity, metaclass=arvet.database.entity.AbstractEntityMetaclass):
    """
...
class VisionSystemTrainee(arvet.database.entity.Entity, metaclass=arvet.database.entity.AbstractEntityMetaclass):
    """
    ...
    def required_training_type(self):
        ...
        :rtype arvet.core.sequence_type.ImageSequenceType:
        """
        pass
...
class TrainedVisionSystem(arvet.core.system.VisionSystem, metaclass=arvet.database.entity.AbstractEntityMetaclass):
    """
