...
class TestBenchmarkComparisonResult(entity_test.EntityContract, unittest.TestCase):
    ...
    def get_class(self):
        return arvet.core.benchmark_comparison.BenchmarkComparisonResult
    ...
    def make_instance(self, *args, **kwargs):
        ...
        return arvet.core.benchmark_comparison.BenchmarkComparisonResult(*args, **kwargs)
    ...
    def assert_models_equal(self, benchmark_result1, benchmark_result2):
        ...
        :return:
        """
        if (not isinstance(benchmark_result1, arvet.core.benchmark_comparison.BenchmarkComparisonResult) or
                not isinstance(benchmark_result2, arvet.core.benchmark_comparison.BenchmarkComparisonResult)):
