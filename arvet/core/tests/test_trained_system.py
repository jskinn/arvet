...
# import arvet.core.trained_system
#
#
...
#         """
#         return mock.create_autospec(arvet.core.trained_system.VisionSystemTrainee)
#
...
#
#
# class MockTrainedSystem(arvet.core.trained_system.TrainedVisionSystem):
#     """
...
#
#
# class TestTrainedSystem(arvet.database.tests.test_entity.EntityContract, unittest.TestCase):
#
#     def get_class(self):
...
#         :return:
#         """
#         if (not isinstance(trial_result1, arvet.core.trained_system.TrainedVisionSystem) or
#                 not isinstance(trial_result2, arvet.core.trained_system.TrainedVisionSystem)):
