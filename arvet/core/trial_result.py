...
class TrialResult(arvet.database.entity.Entity):
    """
    ...
    def sequence_type(self):
        ...
        :return: A arvet.core.sequence_type.ImageSequenceType
        """
    ...
    def deserialize(cls, serialized_representation, db_client, **kwargs):
        ...
        if 'sequence_type' in serialized_representation and serialized_representation['sequence_type'] is 'SEQ':
            kwargs['sequence_type'] = arvet.core.sequence_type.ImageSequenceType.SEQUENTIAL
        else:
            kwargs['sequence_type'] = arvet.core.sequence_type.ImageSequenceType.NON_SEQUENTIAL
