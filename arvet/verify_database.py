...
def recalculate_derivative_metadata(db_client: arvet.database.client.DatabaseClient):
    """
...
def check_collection(collection: pymongo.collection.Collection, db_client: arvet.database.client.DatabaseClient):
    """
    ...
    for s_entity in all_entities:
        ...
        if '.' not in s_entity['_type']:
            qual_types = arvet.database.entity_registry.find_potential_entity_classes(s_entity['_type'])
