...
import arvet.simulation.controllers.flythrough_controller as fly


class TestFlythroughController(arvet.database.tests.test_entity.EntityContract, unittest.TestCase):
