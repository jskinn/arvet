...
import arvet.simulation.controllers.combinatorial_sampling_controller as comb_controller
...
def create_mock_simulator():
    mock_simulator = mock.create_autospec(arvet.simulation.simulator.Simulator)
