...
class FlythroughController(arvet.simulation.controller.Controller, arvet.database.entity.Entity):
    """
    ...
    def sequence_type(self):
        ...
        """
        return arvet.core.sequence_type.ImageSequenceType.SEQUENTIAL
    ...
    def get_next_image(self):
        ...
        :return: An Image object (see arvet.core.image) or None, and an index (or None)
        """
    ...
    def can_control_simulator(self, simulator):
        ...
        :return:
        """
        return simulator is not None and isinstance(simulator, arvet.simulation.simulator.Simulator)
