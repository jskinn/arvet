...
class LoopingCollection(arvet.core.image_source.ImageSource, arvet.database.entity.Entity):
    """
    ...
    def __init__(self, inner, repeats=1, type_override=None, id_=None, **kwargs):
        ...
        self._type_override = arvet.core.sequence_type.ImageSequenceType(type_override) if type_override is not None else None
