...
import arvet.image_collections.image_collection_builder as image_collection_builder
...
class TestImageCollectionBuilder(unittest.TestCase):
    ...
    def setUp(self):
        self.mock_db_client = mock.create_autospec(arvet.database.client.DatabaseClient, spec_set=True)
