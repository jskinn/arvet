...
import arvet.image_collections.looping_collection as looper
...
class TestAugmentedCollection(arvet.database.tests.test_entity.EntityContract, unittest.TestCase):
    ...
    def make_instance(self, *args, **kwargs):
        kwargs = du.defaults(kwargs, {
            ...
            'repeats': 3,
            'type_override': arvet.core.sequence_type.ImageSequenceType.SEQUENTIAL
        })
    ...
    def test_can_override_sequence_type(self):
        inner = mock.create_autospec(arvet.core.image_collection.ImageCollection)
        inner.get_next_image.return_value = (make_image(), 10)
        inner.sequence_type.return_value = arvet.core.sequence_type.ImageSequenceType.NON_SEQUENTIAL
        subject = looper.LoopingCollection(inner, 3, type_override=arvet.core.sequence_type.ImageSequenceType.SEQUENTIAL)
