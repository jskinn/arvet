...
class AugmentedImageCollection(arvet.core.image_source.ImageSource, arvet.database.entity.Entity):
    """
...
class ImageAugmenter(arvet.database.entity.Entity, metaclass=arvet.database.entity.AbstractEntityMetaclass):
    """
