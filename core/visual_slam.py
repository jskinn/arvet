...
class SLAMTrialResult(core.trial_result.TrialResult):
    ...
    """
    def __init__(self, dataset_id, system_id, trained_state_id, success, system_settings, id_=None,
                 trajectory=None, tracking_stats=None, dataset_repeats=0, **kwargs):
        super().__init__(dataset_id, system_id, trained_state_id, success, system_settings, id_=id_)
