...
def main(do_imports: bool = True, schedule_tasks: bool = True, experiment_ids: typing.List[str] = None):
    """
...
if __name__ == '__main__':
    ...
    main(not args.skip_imports, not args.skip_schedule_tasks, args.experiment_ids)
