...
class TestToAndFromUnreal(unittest.TestCase):
    ...
    def test_pose_from_unreal(self):
        ...
        self.assert_array((37, -97, 113), pose.location)
        self.assert_close(tf.quaternions.axangle2quat((1, 2, 3), np.pi/4), pose.rotation_quat(w_first=True))
...
class TestUnrealTransform(unittest.TestCase):
    ...
    def test_find_independent_point_moves_origin(self):
        ...
        self.assert_array((11, 12, 13), point_rel)
    ...
    def test_find_independent_pose_moves_origin(self):
        ...
        self.assert_array((11, 12, 13), pose_rel.location)

    def test_find_independent_point_changes_location_coordinates(self):
        point = (1, 3, 5)
        trans = uetrans.UnrealTransform(location=(10, 9, 8), rotation=(10, 20, 90))
        point_rel = trans.find_independent(point)
        self.assert_close((6.177, 8.434, 12.480), point_rel)

    def test_find_independent_pose_changes_location_coordinates(self):
        pose = uetrans.UnrealTransform(location=(1, 3, 5), rotation=(45, 30, -30))
        trans = uetrans.UnrealTransform(location=(10, 9, 8), rotation=(10, 20, 90))
        pose_rel = trans.find_independent(pose)
        self.assert_close((6.177, 8.434, 12.480), pose_rel.location)

    def test_find_independent_pose_changes_orientation(self):
        pose = uetrans.UnrealTransform(location=(1, 3, 5), rotation=(45, 30, -30))
        trans = uetrans.UnrealTransform(location=(10, 9, 8), rotation=(10, 20, 90))
        pose_rel = trans.find_independent(pose)
        self.assert_close((42.224522, 52.174339, 56.373390), pose_rel.euler)
